...
const Battery = () => {
    ...
    const BatteryPercentage = () => Widget.Label({
...
const Volume = () => {
    ...
    const VolumePercentage = () => Widget.Label().hook(audio.speaker, self => {
...
const PowerProfile = () => {
    ...
    const powerProfileBox = () => Widget.Box({
        children: [
            label()
        ]
    })
